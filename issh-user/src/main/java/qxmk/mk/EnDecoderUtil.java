...
//        md5.update(text.getBytes());
     ...
     * @return byte[]
     */
    public static byte[] DESDecrypt(final String encoderContent, final String key) {
        return processCipher(encoderContent.getBytes(), getSecretKey(key), Cipher.DECRYPT_MODE, ALGORITHM_DES);
    }
